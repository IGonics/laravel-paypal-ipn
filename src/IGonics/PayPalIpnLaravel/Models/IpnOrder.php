...
namespace IGonics\PayPalIpnLaravel\Models;
...
/**
 * An Eloquent Model: 'IGonics\PayPalIpnLaravel\Models\IpnOrder'
 *
 * @property integer $id
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\IGonics\PayPalIpnLaravel\Models\IpnOrderItem[] $items
 */
class IpnOrder extends Model
{
    ...
    public function items() {
        return $this->hasMany(IpnOrderItem::class);
    }
